...
/**
 * <p>
 * A copy/paste of the final class from prefuse with very few changes.
 * It enables the drawing of mixed networks 
 * (add a the relevant field {link #FIELD_DIRECTED} in your edge table and fill it with booleans).
 * </p>
 * 
 ...
 */
public final class MyEdgeRenderer extends AbstractShapeRenderer {
    ...
    protected Shape getRawShape(VisualItem item) {
        ...
        // Sam: originally uses e.isDirected(), which actually calls graph isdirected
        
        Integer typeEdgeId = (Integer)e.get(ClientWhiteboardSWT.PREFUSE_EDGE_FIELD_TYPE);
        //WhiteboardSWT.TypeEdge typeEdge = WhiteboardSWT.TypeEdge.values()[typeEdgeId];
        
        boolean directed = (typeEdgeId != null) && ClientWhiteboardSWT.TypeEdge.values()[typeEdgeId].directed;
        if (directed && m_edgeArrow != Constants.EDGE_ARROW_NONE ) {
     ...
     * 
     * Nota: silently catches all runtimeexceptions
     */
